 ...
 * @brief provide base interface for proto
 * 
 * @par license
 *  GPL-3.0 license
 * @version 0.1
...
public:
    ...
    /**
     * @brief serializer self by SerializerT
     * 
    ...
    /**
     * @brief deserializer self by SerializerT
...
CS_STRING_VIEW ProtoBase<T, SerializerT>::_init_class_name__ = []() {
    static_assert(std::is_base_of<ProtoBaseType, T>::value, "T must inherit from ProtoBaseType");
