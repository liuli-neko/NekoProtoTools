...
struct ServeNetworkOptions {
    ...
    struct Neko {
        constexpr static auto value = // NOLINT
            Object("host",
                   make_tags<arg_name<"host">, arg_value_name<"HOST">, arg_env<"NEKO_ARGPARSER_MANUAL_HOST">,
...
struct ServeCommand {
    ...
    struct Neko {
        constexpr static auto value = // NOLINT
            Object(
                "network", &ServeCommand::network, "verbose",
                make_tags<arg_name<"verbose", "v">, arg_group<"General">, arg_help<"enable verbose output">,
                          arg_aliases<"V", "debug">, ArgTags{.flag = true}>(&ServeCommand::verbose),
                "config",
                make_tags<arg_name<"config", "c">, arg_group<"General">, arg_env<"NEKO_ARGPARSER_MANUAL_CONFIG">,
                          arg_value_name<"FILE">, arg_help<"config file">>(&ServeCommand::config),
                "include",
                make_tags<arg_name<"include", "I">, arg_group<"Paths">, arg_separator<','>, arg_value_name<"DIRS">,
                          arg_help<"extra include directories">, ArgTags{.repeatable = true}>(
    ...
    struct Neko {
        constexpr static auto value = // NOLINT
            Object(
                ...
                "dryRun",
                make_tags<arg_name<"dry-run">, arg_group<"Build">, arg_help<"show work without executing">,
                          arg_conflicts<"release">, ArgTags{.flag = true}>(&BuildCommand::dryRun),
                "legacy",
                make_tags<arg_name<"legacy-mode">, arg_group<"Compatibility">, arg_help<"legacy build mode">,
                          arg_deprecated<"use --mode release instead">, ArgTags{.flag = true}>(&BuildCommand::legacy),
                "traceParser",
                make_tags<arg_name<"trace-parser">, arg_help<"internal parser tracing">,
                ...
                make_tags<arg_name<"output", "o">, arg_group<"Paths">, arg_env<"NEKO_ARGPARSER_MANUAL_OUTPUT">,
                          arg_value_name<"DIR">, arg_default<"build"_cs>, arg_help<"output directory">>(
                    &BuildCommand::output),
                "mode",
                ...
                make_tags<arg_name<"define", "D">, arg_group<"C/C++">, arg_separator<','>, arg_value_name<"DEFINE">,
                          arg_help<"preprocessor definitions">, ArgTags{.repeatable = true}>(&BuildCommand::defines),
                "publish",
                make_tags<arg_name<"publish">, arg_group<"Publish">, arg_help<"publish build artifact">,
                          arg_requires<"token">, ArgTags{.flag = true}>(&BuildCommand::publish),
                "token",
                make_tags<arg_name<"token">, arg_group<"Publish">, arg_env<"NEKO_ARGPARSER_MANUAL_TOKEN">,
                          arg_value_name<"TOKEN">, arg_help<"publish token">>(&BuildCommand::token),
                "json",
                make_tags<arg_name<"json">, arg_group<"Output">, arg_help<"json diagnostics">, arg_conflicts<"yaml">,
                          ArgTags{.flag = true}>(&BuildCommand::json),
                "yaml",
                make_tags<arg_name<"yaml">, arg_group<"Output">, arg_help<"yaml diagnostics">, ArgTags{.flag = true}>(
                    &BuildCommand::yaml),
                "target",
                make_tags<arg_name<"target">, arg_help<"target name">, ArgTags{.positional = true}>(
                    &BuildCommand::target));
    };
};
...
struct ToolCommands {
    ...
    struct Neko {
        constexpr static auto value = // NOLINT
            Object("serve",
                   make_tags<arg_name<"serve">, arg_help<"run an HTTP-like demo server">, ArgTags{.command = true}>(
                       &ToolCommands::serve),
                   "build",
                   make_tags<arg_name<"build">, arg_help<"build a target">, ArgTags{.command = true}>(
                       &ToolCommands::build),
                   "clean",
                   make_tags<arg_name<"clean">, arg_help<"remove generated files">, ArgTags{.command = true}>(
                       &ToolCommands::clean));
    };
};
        ...
        constexpr static auto value = // NOLINT
            Object("verbose",
                   ...
                   make_tags<arg_name<"token">, arg_group<"Security">, arg_env<"NEKO_ARGPARSER_MANUAL_TOKEN">,
                             arg_value_name<"TOKEN">, arg_help<"login token">>(&StandaloneOptions::token),
                   "login",
                   make_tags<arg_name<"login">, arg_group<"Security">, arg_requires<"token">, arg_help<"enable login">,
                             ArgTags{.flag = true}>(&StandaloneOptions::login),
                   "json",
                   make_tags<arg_name<"json">, arg_group<"Output">, arg_conflicts<"yaml">, arg_help<"json output">,
                             ArgTags{.flag = true}>(&StandaloneOptions::json),
                   "yaml",
                   make_tags<arg_name<"yaml">, arg_group<"Output">, arg_help<"yaml output">, ArgTags{.flag = true}>(
                       &StandaloneOptions::yaml),
                   "legacyMode",
                   make_tags<arg_name<"legacy-mode">, arg_group<"Compatibility">,
                             arg_deprecated<"use --mode release instead">, arg_help<"legacy compatibility flag">,
