...
public:
     ...
     */
    inline bool fromData(const char* data, size_t size) NEKO_NOEXCEPT;
    /**
     * @brief type
...
inline bool IProto::fromData(const char* data, size_t size) NEKO_NOEXCEPT {
    if (mImp) {
...
inline bool IProto::operator==(nullptr_t) { return mImp == nullptr; }
template <typename T>
